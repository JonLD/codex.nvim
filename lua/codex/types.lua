-- This file defines Codex.nvim types.
---@meta
---@brief [[
...
---@field unfocus_key string|false|nil  -- Key to return to the previous window from the Codex terminal
---@field unfocus_mapping string|nil    -- Command executed in terminal mode to move focus
...
---@field auth_mode "required"|"optional"|"disabled" -- Auth header handling policy
---@field fallback_to_terminal_send boolean -- Whether to send to the terminal when Codex is not connected
