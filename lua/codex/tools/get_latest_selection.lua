-- This file implements the MCP tool "get_latest_selection" to fetch the latest selection.
--- Tool implementation for getting the latest text selection.

local schema = {
  description = "Get the most recent visual selection (even if not in the active editor)",
  inputSchema = {
    type = "object",
...
local function handler(params)
  ...
  local selection = selection_module.get_latest_visual_selection()
